...
<div class="navbar-header">
   <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar">
	...
	<h5 align="center">
		<img src="assets/images/dinas.png" width="40" height="40">
		<font color="white" style="bold"><b>Tryout Online</b></font>
	</h5>
</div>
...
//   echo menu_siswa("view_topik.php", "list-alt", "Topik");
   echo menu_siswa("view_ujian.php", "list-alt", "Soal Tryout");
